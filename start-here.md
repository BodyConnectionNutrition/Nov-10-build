...
title: Start Here
eyebrow: Your first step is free
intro: Before you try to change yourself, learn to see what is already shaping you.
---
Most health advice begins with instructions: eat this, avoid that, exercise more, try harder.
...
<p class="eyebrow">A gift, and a beginning</p>
<h2>I want you to experience the value of this work before I ask you to invest in it.</h2>
...
Hunger. Fullness. Fatigue. Tension. Thirst. Comfort. Energy.

Your body is communicating all the time. But over a lifetime, those signals can become surrounded by rules, expectations, judgment, and ideas about what your body <em>should</em> need.

**Can You Hear Your Body?** is a short interactive experience that helps you explore the space between a body signal and what happens next.

You will look at three dimensions:

<div class="three-grid" style="margin:2rem 0">
  <article class="card"><span class="number">1</span><h3>Signal</h3><p>How clearly do I notice what my body is telling me?</p></article>
  <article class="card"><span class="number">2</span><h3>Interpretation</h3><p>How do I decide what that sensation means?</p></article>
  <article class="card"><span class="number">3</span><h3>Permission</h3><p>What happens once I recognize what I need?</p></article>
</div>

There is no score to achieve and nothing you are supposed to fix. The purpose is to notice something that may usually happen automatically.

<p><a class="button" href="/tools/can-you-hear-your-body/">Begin the free experience →</a></p>
...
Advanced education often asks us to examine the assumptions and frameworks through which we interpret the world. We identify them, investigate where they came from, compare them with evidence and experience, and revise them when they no longer hold.
